...
public class CategoryAdminController {
    ...
    public ResponseEntity<CategoryDto> addCategory(@RequestBody
                                                   @Validated(Validator.Create.class) CategoryDto requestCategory,
                                                   BindingResult bindingResult) {
        log.info("Calling the POST request to /admin/categories endpoint");
        if (bindingResult.hasErrors()) {
            log.error("Validation error with category");
    ...
    public ResponseEntity<CategoryDto> updateCategory(@PathVariable Long catId,
                                                      @RequestBody
                                                      @Validated(Validator.Update.class) CategoryDto categoryDto) {
