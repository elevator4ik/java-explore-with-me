...
public class EventPrivateController {
    ...
    public ResponseEntity<EventFullDto> createEvent(@PathVariable Long userId,
                                                    @RequestBody
                                                    @Validated EventRequestDto eventRequestDto) {
        log.info("Calling the POST request to /users/{userId}/events");
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(eventPrivateService.createEvent(userId, eventRequestDto));
    }
    ...
    public ResponseEntity<EventFullDto> patchEvent(@PathVariable Long userId,
                                                   ...
                                                   @RequestBody
                                                   @Validated(Validator.Update.class) UpdateEventDto receivedDto) {
    ...
    public ResponseEntity<RequestShortUpdateDto> patchRequestByOwnerUser(@PathVariable Long userId,
                                                                         @PathVariable Long eventId,
