...
public class EventMapper {
    ...
    public PatchEventDto toEventFromUpdateEvent(UpdateEventDto updateEventDto) {
        ...
        event.setLocation(updateEventDto.getLocation() == null ? null :
                LocationMapper.toLocation(updateEventDto.getLocation()));
        return event;
    }
    ...
    public static EventAdminDto toAdminEventFromAdminDto(AdminEventRequestDto adminEvent) {
        ...
        event.setLocation(adminEvent.getLocation() == null ? null :
