...
public class EventAdminController {
    ...
    public ResponseEntity<EventFullDto> patchAdminEvent(@PathVariable Long eventId,
                                                        @RequestBody
                                                        @Validated({Validator.Update.class})
                                                                AdminEventRequestDto adminEventDto) {
        log.info("Calling the PATCH request to /admin/events/{eventId} endpoint");
