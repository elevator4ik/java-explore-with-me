...
public class CompilationAdminController {
    ...
    public ResponseEntity<CompilationDto> postCompilations(@RequestBody
                                                           @Validated(Validator.Create.class)
    ...
    public ResponseEntity<String> deleteCompilation(@PathVariable Long compId) {
        log.info("Calling the DELETE request to /admin/compilations/{compId} endpoint");
